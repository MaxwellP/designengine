...
* @param {Number} cardID - an optional field containing the id of the card the action came from
...
*/
function Action(name, template, cardID, inputs, checkLegality, result)
{
	this.name = name;
